...
func (obj *_EntFileMgr) WithCategoryID(categoryID string) Option {
...
func (obj *_EntFileMgr) WithFileTypeID(fileTypeID string) Option {
...
func (obj *_EntFileMgr) WithIsDeleted(isDeleted bool) Option {
...
func (obj *_EntFileMgr) GetFromCategoryID(categoryID string) (results []*EntFile, err error) {
...
func (obj *_EntFileMgr) GetBatchFromCategoryID(categoryIDs []string) (results []*EntFile, err error) {
...
func (obj *_EntFileMgr) GetFromFileTypeID(fileTypeID string) (results []*EntFile, err error) {
...
func (obj *_EntFileMgr) GetBatchFromFileTypeID(fileTypeIDs []string) (results []*EntFile, err error) {
...
func (obj *_EntFileMgr) GetFromIsDeleted(isDeleted bool) (results []*EntFile, err error) {
	err = obj.DB.WithContext(obj.ctx).Model(EntFile{}).Where("`IsDeleted` = ?", isDeleted).Find(&results).Error

	return
}

// GetBatchFromIsDeleted 批量查找 是否删除
func (obj *_EntFileMgr) GetBatchFromIsDeleted(isDeleteds []bool) (results []*EntFile, err error) {
	err = obj.DB.WithContext(obj.ctx).Model(EntFile{}).Where("`IsDeleted` IN (?)", isDeleteds).Find(&results).Error
