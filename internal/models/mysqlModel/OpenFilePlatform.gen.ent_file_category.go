...
func (obj *_EntFileCategoryMgr) WithCategoryID(categoryID string) Option {
	return optionFunc(func(o *options) { o.query["CategoryID"] = categoryID })
}

// WithCategoryParentID CategoryParentID获取  父级ID
func (obj *_EntFileCategoryMgr) WithCategoryParentID(categoryParentID string) Option {
...
func (obj *_EntFileCategoryMgr) WithIsDeleted(isDeleted bool) Option {
...
func (obj *_EntFileCategoryMgr) GetFromCategoryID(categoryID string) (results []*EntFileCategory, err error) {
...
func (obj *_EntFileCategoryMgr) GetBatchFromCategoryID(categoryIDs []string) (results []*EntFileCategory, err error) {
...
func (obj *_EntFileCategoryMgr) GetFromCategoryParentID(categoryParentID string) (results []*EntFileCategory, err error) {
...
func (obj *_EntFileCategoryMgr) GetBatchFromCategoryParentID(categoryParentIDs []string) (results []*EntFileCategory, err error) {
...
func (obj *_EntFileCategoryMgr) GetFromIsDeleted(isDeleted bool) (results []*EntFileCategory, err error) {
	err = obj.DB.WithContext(obj.ctx).Model(EntFileCategory{}).Where("`IsDeleted` = ?", isDeleted).Find(&results).Error

	return
}

// GetBatchFromIsDeleted 批量查找 是否删除
func (obj *_EntFileCategoryMgr) GetBatchFromIsDeleted(isDeleteds []bool) (results []*EntFileCategory, err error) {
	err = obj.DB.WithContext(obj.ctx).Model(EntFileCategory{}).Where("`IsDeleted` IN (?)", isDeleteds).Find(&results).Error
