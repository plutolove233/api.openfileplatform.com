...
func (obj *_EntUsersMgr) WithIsAdmin(isAdmin bool) Option {
...
func (obj *_EntUsersMgr) GetFromIsAdmin(isAdmin bool) (results []*EntUsers, err error) {
...
func (obj *_EntUsersMgr) GetBatchFromIsAdmin(isAdmins []bool) (results []*EntUsers, err error) {
