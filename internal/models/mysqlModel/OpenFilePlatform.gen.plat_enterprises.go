...
func (obj *_PlatEnterprisesMgr) WithIsDeleted(isDeleted bool) Option {
	return optionFunc(func(o *options) { o.query["IsDeleted"] = isDeleted })
}

// WithCreateTime CreateTime获取
func (obj *_PlatEnterprisesMgr) WithCreateTime(createTime time.Time) Option {
...
func (obj *_PlatEnterprisesMgr) GetFromIsDeleted(isDeleted bool) (results []*PlatEnterprises, err error) {
	err = obj.DB.WithContext(obj.ctx).Model(PlatEnterprises{}).Where("`IsDeleted` = ?", isDeleted).Find(&results).Error

	return
}

// GetBatchFromIsDeleted 批量查找
func (obj *_PlatEnterprisesMgr) GetBatchFromIsDeleted(isDeleteds []bool) (results []*PlatEnterprises, err error) {
	err = obj.DB.WithContext(obj.ctx).Model(PlatEnterprises{}).Where("`IsDeleted` IN (?)", isDeleteds).Find(&results).Error

	return
}

// GetFromCreateTime 通过CreateTime获取内容
func (obj *_PlatEnterprisesMgr) GetFromCreateTime(createTime time.Time) (results []*PlatEnterprises, err error) {
	err = obj.DB.WithContext(obj.ctx).Model(PlatEnterprises{}).Where("`CreateTime` = ?", createTime).Find(&results).Error

	return
}

// GetBatchFromCreateTime 批量查找
func (obj *_PlatEnterprisesMgr) GetBatchFromCreateTime(createTimes []time.Time) (results []*PlatEnterprises, err error) {
	err = obj.DB.WithContext(obj.ctx).Model(PlatEnterprises{}).Where("`CreateTime` IN (?)", createTimes).Find(&results).Error
