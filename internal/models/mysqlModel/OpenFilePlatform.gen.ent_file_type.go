...
func (obj *_EntFileTypeMgr) WithFileTypeID(fileTypeID string) Option {
...
func (obj *_EntFileTypeMgr) GetFromFileTypeID(fileTypeID string) (results []*EntFileType, err error) {
...
func (obj *_EntFileTypeMgr) GetBatchFromFileTypeID(fileTypeIDs []string) (results []*EntFileType, err error) {
